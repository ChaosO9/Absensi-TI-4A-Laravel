        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4 shadow">
                ...
                @if (Session::has("success2"))
                    <div
                        class="alert alert-info radius ml-5 mr-5 mt-1"
                        role="alert"
                    >
                    ...
                    <div class="ml-2 mr-5 mt-2">
                        <div class="d-flex justify-content-between">
                            <a
                                href="{{ Route("lihatmhs") }}"
                                class="btn btn-info radius ml-auto block"
                            >
                                {{ __("Kembali") }}
                            </a>
                        </div>
                ...
                <div class="card-body">
                    <form
                        ...
                        action="{{ Route("update_mahasiswa_proses", ["nim_asal" => $nim]) }}"
                        method="POST"
                        novalidate
                    >
                        @csrf
                        <div class="form-group">
                            <div class="form-group ml-2 mr-5">
                                ...
                                <input
                                    ...
                                    placeholder="{{ __("Contoh") }}: 216151001"
                                    value="{{ $nim }}"
                                    readonly
                                    required
                                />
                            ...
                            <div class="form-group ml-2 mr-5">
                                ...
                                <input
                                    ...
                                    id="nama"
                                    class="form-control form-control-lg radius"
                                    placeholder="{{ __("Contoh") }}: Andika Saputra"
                                    value="{{ $nama }}"
                                    required
                                />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group ml-2 mr-5">
                                ...
                                <label
                                    for="photo"
                                    class="form-label text-dark ml-2 mt-3"
                                >
                                    Format: jpg/png
                                </label>
                            </div>
                            <div class="ml-2 mr-5 mt-4">
                                <div class="d-flex justify-content-between">
                                    <button
                                        type="submit"
                                        class="btn btn-primary radius mr-3 block"
                                        name="submit"
                                    >
                                        {{ __("Perbarui Data") }}
                                    </button>
                                    <button
                                        type="button"
                                        class="btn btn-danger radius block"
                                        data-toggle="modal"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ __("Pilih Hapus untuk menghapus data") }}
                    </div>
                    <div class="modal-footer">
                        ...
                        <form
                            action="{{ Route("hapus_mahasiswa", ["nim" => $nim]) }}"
                            method="POST"
                        >
                            @csrf
