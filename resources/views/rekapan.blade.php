...
@section('container')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="mb-5 text-gray-800">Rekapan Absensi</h1>
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="myForm" role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" name="postform">
                            ...
                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Atur
                                Rekapan</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-xl-8 col-md-8 animated--fade-in">
                <div class="card shadow mb-4">
                    ...
                    <a class="d-block card-header w-100 py-3" role="button" aria-expanded="true" aria-controls="absen">
                        <h6 class="m-0 font-weight-bold text-primary">Daftar Rekapan Absen Sementara</h6>
                    </a>
                    <!-- Card Content - Collapse -->
                    <div class="d-block card-body">
                        <p>Perlihatkan Absen Berikut Kepada Dosen dan Menyetujui Rekapan Berikut</p>
                        <form action="">
                            ...
                            <hr>
                            <button type="submit" name="submit" value="submit" class="btn btn-primary">Setujui
                                Rekapan</button>
                        </form>
                    </div>
                </div>
