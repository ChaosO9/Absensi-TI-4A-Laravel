    ...
    <div class="container-fluid">
        ...
        <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div
                                            class="h5 font-weight-bold mb-0 text-gray-800"
                                        >
                                            {{ $jumlah_mahasiswa }}
                                            ({{ __("mahasiswa") }})
                                        </div>
            ...
            <div class="col-xl-6 col-md-6 mb-4">
                        ...
                        >
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <i
                                            class="fas fa-book fa-2x text-gray-300"
                                        ></i>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="font-sans font-semibold text-slate-700">
                    Saya Irfan
                </div>
            </div>
            <!-- Akhir Rekap Absensi -->
